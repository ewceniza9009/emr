...
| **Infrastructure**          | [![Database: PostgreSQL](https://img.shields.io/badge/Database-PostgreSQL-336791.svg)](https://www.postgresql.org/) [![Search: Elasticsearch](https://img.shields.io/badge/Search-Elasticsearch-005571.svg)](https://www.elastic.co/elasticsearch/) [![Storage: Azurite](https://img.shields.io/badge/Storage-Azurite--Cloud-blue.svg)](https://github.com/Azure/Azurite)                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| **Clinical Assessments**    | Multi-instrument assessment suite (ESAS-R, PHQ-9, PPS, FICA) with interactive scoring sliders.                      | ![Clinical Assessments](qa_report/assets/patient_detail_assessment.png)   |
...
- **Mobile Portal & Patient Experience:** Telehealth video consults, Active Medication lists/pill reminders, in-app billing settlement, insurance card scanning, wearable telemetry simulation, and "Visit Radar" real-time transit tracking.
...
- **Revenue Cycle Management (RCM):** Mobile payment settlement _(Planned)_, insurance card scanning _(Planned)_, and benefits claim tracking _(Planned)_.
...
- **Benefits Claim Tracking:** Integrated support for insurance claims and status tracking.
- **Mobile Payment Settlement:** In-app co-pay settlement for patients.
- **Insurance Card Scanning:** Camera-based scanning to extract policy numbers and link to care records.
