...
export default function NewInvoicePage() {
  ...
  return (
    <div className="w-full h-[calc(100vh-70px)] bg-[var(--background)] text-[var(--text-secondary)] selection:bg-[#cfe2ff] selection:text-[#000000] flex flex-col overflow-hidden">
      <div className="flex-1 w-full space-y-4 animate-fade-in max-w-[1600px] mx-auto pt-4 px-6 flex flex-col min-h-0 h-full">
        <PatientLookup
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 pb-4 border-b border-[var(--card-border)] relative shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div className="space-y-0.5">
              <div className="flex items-center gap-2">
                <h1 className="text-xl font-black tracking-tighter uppercase leading-none text-[var(--text-primary)]">
                  Billing Station
                </h1>
              ...
              <p className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-[0.3em] flex items-center gap-2">
                Revenue Cycle{" "}
                <span className="w-0.5 h-0.5 rounded-full bg-[var(--card-border)] opacity-30" />{" "}
                Sector 7-G
              </p>
            </div>
          </div>
        ...
        <div className="grid grid-cols-12 gap-6 flex-1 min-h-0 pb-6 overflow-hidden">
          {/* Main Ledger Area - Form Locked to Viewport Height */}
          <div className="col-span-12 xl:col-span-8 flex flex-col min-h-0 h-full overflow-hidden">
            <div className="bg-[var(--card-bg)] rounded-[1.5rem] border border-[var(--card-border)] shadow-xl relative overflow-hidden backdrop-blur-xl flex flex-col h-full">
              ...
              {/* Premium Header */}
              <div className="p-5 pb-2 flex items-center justify-between relative shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[8px] font-bold text-[var(--text-muted)] uppercase tracking-widest mt-0.5 opacity-50">
                      Transaction distribution & itemization
                    </p>
                  </div>
                </div>
                <button
              ...
              <div className="flex-1 flex flex-col min-h-0 relative overflow-hidden">
                {/* Header Row (Static) */}
                <div className="px-6 grid grid-cols-12 gap-4 py-3 px-4 opacity-50 sticky top-0 bg-[var(--card-bg)] z-10 shrink-0">
                  <div className="col-span-6 text-[9px] font-black uppercase tracking-[0.2em]">
                    Nomenclature / Service
                  </div>
                  <div className="col-span-1 text-[9px] font-black uppercase tracking-[0.2em] text-center">
                    Unit
                  </div>
                  <div className="col-span-2 text-[9px] font-black uppercase tracking-[0.2em] text-right">
                    Rate
                  </div>
                  <div className="col-span-2 text-[9px] font-black uppercase tracking-[0.2em] text-right">
                    Valuation
                ...
                <div className="flex-1 overflow-y-auto px-6 pb-6 space-y-2 custom-scrollbar">
                  {lineItems.map((item) => (
                    <div
                      key={item.id}
                      className="grid grid-cols-12 gap-4 items-center p-2 bg-[var(--input-bg)]/30 hover:bg-[var(--input-bg)]/50 border border-[var(--card-border)] rounded-xl transition-all group"
                    >
                      ...
                      <div className="col-span-2">
                        <div className="relative group/input">
                          <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[9px] font-black opacity-30">
                            {currencySymbol}
                          </span>
                          <input
                            type="number"
              ...
              <div className="p-6 bg-[var(--input-bg)]/10 border-t border-[var(--card-border)] grid grid-cols-1 lg:grid-cols-12 gap-6 shrink-0">
                <div className="lg:col-span-7 space-y-3">
                  <div className="flex items-center gap-2">
                    ...
                    <label className="text-[8px] font-black uppercase tracking-[0.3em] opacity-40">
                      Documentation / Terms
                    </label>
                  </div>
                  <textarea
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center px-4 py-2.5 bg-[var(--input-bg)]/50 rounded-xl border border-[var(--card-border)] group/adj">
                      ...
                      <div className="relative w-28">
                        <span className="absolute left-0 top-1/2 -translate-y-1/2 text-[10px] font-black opacity-20">
                          {currencySymbol}
                        </span>
                        <input
                          type="number"
          ...
          {/* Framework & Entities - The Only Scrollable Panel on Desktop */}
          <div className="col-span-12 xl:col-span-4 space-y-4 xl:self-start h-full xl:overflow-y-auto custom-scrollbar pb-6 pr-1">
            {/* Recipient Module */}
            <div className="bg-[var(--card-bg)] rounded-[1.5rem] border border-[var(--card-border)] p-6 shadow-xl relative overflow-hidden group flex flex-col min-h-[260px] shrink-0">
              ...
              <div className="flex items-center justify-between relative mb-6">
                <h3 className="text-[9px] font-black uppercase tracking-[0.2em] opacity-40">
                  Recipient Protocol
                </h3>
                {selectedPatient && (
                  <button
                ...
                {selectedPatient ? (
                    ...
                    <div className="space-y-2 pt-4 border-t border-[var(--card-border)]">
                      <div className="flex items-center gap-3 text-[9px] font-black uppercase tracking-widest p-3 bg-[var(--input-bg)]/30 rounded-xl border border-[var(--card-border)]">
                        ...
                        <span className="text-[var(--text-secondary)]">
                          {selectedPatient.metadata || "METROPOLIS CLUSTER"}
                        </span>
                      </div>
                      <div className="flex items-center gap-3 text-[9px] font-black uppercase tracking-widest p-3 bg-[var(--input-bg)]/30 rounded-xl border border-[var(--card-border)]">
                  ...
                  >
                    ...
                    <div className="text-center space-y-1 relative">
                      <p className="text-[11px] font-black uppercase tracking-[0.2em] text-[var(--text-primary)]/60">
                        Initialize Entity
                      </p>
                      <p className="text-[8px] font-bold text-[var(--text-muted)] uppercase tracking-[0.1em] px-8 leading-relaxed">
                        Registry Linkage Required
                      </p>
                    </div>
                  </button>
                )}
            ...
            <div className="bg-[var(--card-bg)] rounded-[1.5rem] border border-[var(--card-border)] p-6 shadow-xl flex flex-col relative overflow-hidden group min-h-[260px] shrink-0">
              <div className="flex items-center justify-between mb-6">
                ...
                {selectedPatient && claims.length > 0 && (
                  <span className="px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-500 text-[7px] font-black uppercase tracking-widest">
                    Active Claims
                  </span>
                )}
              </div>
              ...
              {selectedPatient ? (
                  ...
                  {claims.length > 0 ? (
                    claims.map((claim: any) => (
                      <button
                        ...
                        className={`w-full p-4 rounded-2xl border transition-all text-left group/claim ${
                          selectedClaimId === claim.claimId
                      ...
                      >
                        <div className="flex justify-between items-start mb-3">
                          <div className="space-y-0.5">
                            <p
                              className={`text-[8px] font-black uppercase tracking-widest ${selectedClaimId === claim.claimId ? "text-white/60" : "text-[var(--text-muted)]"}`}
                            >
                              PhilHealth PIN
                            </p>
                    ...
                    <div className="py-12 border-2 border-dashed border-[var(--card-border)] rounded-[2.5rem] flex flex-col items-center justify-center text-center px-8">
                      ...
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--text-muted)]">
                        No active benefit claims found for this entity
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center opacity-30 pb-4">
                  ...
                  <p className="text-[9px] font-black uppercase tracking-[0.2em] text-center max-w-[140px] leading-relaxed">
                    Select patient to query registry
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-[var(--card-bg)] rounded-[1.5rem] border border-[var(--card-border)] p-5 shadow-xl space-y-4 relative overflow-visible flex flex-col shrink-0">
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div className="flex flex-col gap-2 relative">
                    <label className="text-[8px] font-black text-[var(--text-muted)] uppercase tracking-[0.3em] ml-1">
                      Invoice Date
                    </label>
                    <CustomDatePicker
                      value={invoiceDate}
