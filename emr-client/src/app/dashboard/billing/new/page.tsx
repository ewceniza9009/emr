          ...
          <div className="flex items-start gap-8">
             ...
             <div className="space-y-2">
                ...
                <p className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-[0.5em] flex items-center gap-2">
                   Aura Clinical Revenue Cycle <span className="w-1 h-1 rounded-full bg-[var(--card-border)]" /> Sector 7-G
                </p>
             </div>
          </div>
                      ...
                      {claims.length > 0 ? (
                        claims.map((claim: any) => (
                          <button
                            ...
                            className={`w-full p-6 rounded-3xl border transition-all text-left group/claim ${
                          ...
                          >
                             <div className="flex justify-between items-start mb-4">
                                ...
                                <div className={`px-3 py-1 rounded-lg text-[8px] font-black uppercase tracking-widest ${
                                  selectedClaimId === claim.claimId ? 'bg-white/20 text-white' : 'bg-[var(--primary)]/10 text-[var(--primary)]'
                                }`}>
                                   {claim.packageCode}
                                </div>
                             </div>
                       ...
                       <div className="grid grid-cols-2 gap-4">
                          {[15, 30, 45, 60].map(days => (
                            <button
                              ...
                              className={`py-5 rounded-2xl border text-[11px] font-black uppercase tracking-widest transition-all ${
                                dueInDays === days 
