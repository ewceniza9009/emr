                      ...
                      <div className="flex flex-wrap justify-center gap-8">
                        {appointment.supportingClinicians.map((sc: any) => (
                          <div key={sc.practitionerId} className="flex flex-col items-center gap-3 group cursor-default">
                            <div className="w-12 h-12 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 group-hover:bg-blue-500/20 group-hover:bg-blue-500/40 group-hover:scale-110 transition-all duration-300 shadow-sm">
                    ...
                    {[
                      ...
                      <div key={section.id} className="space-y-2 relative">
                        ...
                        <SmartTextarea
                          ...
                          onChange={val => setNote(prev => ({ ...prev, [section.id]: val }))}
                          smartPhrases={smartPhrases}
