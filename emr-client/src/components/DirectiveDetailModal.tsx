    ...
    <HalcyonPortal>
      ...
      >
        ...
        >
          ...
          {/* Footer */}
          <div className="px-8 py-5 border-t border-[var(--card-border)] shrink-0 flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 w-full">
                ...
                {!isEditing && (
                  <>
                    <button
                      ...
                      disabled={revoking}
                      className="flex items-center gap-2 text-rose-500 text-[10px] font-black uppercase tracking-wider hover:text-rose-400 transition-all disabled:opacity-50 whitespace-nowrap bg-rose-500/5 hover:bg-rose-500/10 px-3.5 py-2 rounded-xl border border-rose-500/10 hover:border-rose-500/20"
                    >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 text-blue-400 text-[10px] font-black uppercase tracking-wider hover:text-blue-350 transition-all whitespace-nowrap bg-blue-500/5 hover:bg-blue-500/10 px-3.5 py-2 rounded-xl border border-blue-500/10 hover:border-blue-500/20"
                    >
              ...
              <button
                ...
                className={`px-8 py-2.5 rounded-xl text-white text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg ${
                  isEditing ? "bg-[var(--primary)] shadow-[var(--primary-glow)]" : "bg-emerald-500 shadow-emerald-500/20"
                } hover:opacity-90 active:scale-95 disabled:opacity-50 whitespace-nowrap w-full sm:w-auto`}
              >
            ...
            {/* System Info */}
            <div className="flex flex-col sm:flex-row sm:items-center justify-between border-t border-[var(--card-border)]/30 pt-3 gap-2 text-[9px] font-black text-[var(--text-muted)] uppercase tracking-widest opacity-50">
              <span className="flex items-center gap-2">
                <Zap className="w-3 h-3" />
                Halkyone Clinical OS · Legal Archive
              </span>
              <span>Secure Reference: AD-{directive.advanceDirectiveId.slice(0, 8).toUpperCase()}</span>
            </div>
          </div>
        </div>
      </div>
