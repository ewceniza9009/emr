...
public class UpdateScheduleBlockCommandHandler(IApplicationDbContext context)
    : IRequestHandler<UpdateScheduleBlockCommand, ScheduleBlock>
{
    public async Task<ScheduleBlock> Handle(
        UpdateScheduleBlockCommand request,
        CancellationToken cancellationToken
    )
    {
        var block = await context.ScheduleBlocks.FirstOrDefaultAsync(
