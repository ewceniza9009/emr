...
public class SeedIntegrationDataCommandHandler : IRequestHandler<SeedIntegrationDataCommand, bool>
{
    ...
    public async Task<bool> Handle(
        SeedIntegrationDataCommand request,
    ...
    )
    {
        ...
        if (
            !await _context.IntegrationProfiles.AnyAsync(
                x => x.Partner == IntegrationPartner.ElationHealth,
                cancellationToken
            )
        )
        {
            _context.IntegrationProfiles.Add(
