...
public class BarrierLogConfiguration : IEntityTypeConfiguration<BarrierLog>
{
    public void Configure(EntityTypeBuilder<BarrierLog> builder)
    {
        ...
        builder.Property(b => b.BarrierId).HasColumnName("barrier_id");

        builder.Property(b => b.CaseId).HasColumnName("case_id").IsRequired();

        builder
            .Property(b => b.BarrierCategory)
