...
public class DiagnosisConfiguration : IEntityTypeConfiguration<Diagnosis>
{
    public void Configure(EntityTypeBuilder<Diagnosis> builder)
    {
        ...
        builder.Property(d => d.DiagnosisId).HasColumnName("diagnosis_id");
        ...
        builder.Property(d => d.DiagnosedAt).HasColumnName("diagnosed_at").IsRequired();
