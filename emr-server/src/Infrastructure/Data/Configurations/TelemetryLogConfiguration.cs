...
public class TelemetryLogConfiguration : IEntityTypeConfiguration<TelemetryLog>
{
    public void Configure(EntityTypeBuilder<TelemetryLog> builder)
    {
        ...
        builder.Property(l => l.EquipmentId).HasColumnName("equipment_id").IsRequired();

        builder
            .Property(l => l.SensorType)
        ...
        builder.Property(l => l.Unit).HasColumnName("unit").HasMaxLength(20).IsRequired();

        builder.Property(l => l.RecordedAt).HasColumnName("recorded_at").IsRequired();
