...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260502013508_InitialCreateNew")]
            ...
            modelBuilder.Entity("Domain.Entities.Patient", b =>
                {
                    ...
                    b.OwnsOne("Domain.Entities.Address", "HomeAddress", b1 =>
                        {
                            ...
                            b1.Property<double?>("Latitude")
                                .HasColumnType("double precision")
                                .HasColumnName("home_address_latitude");

                            b1.Property<double?>("Longitude")
                                .HasColumnType("double precision")
                                .HasColumnName("home_address_longitude");
            ...
            modelBuilder.Entity("Domain.Entities.Practitioner", b =>
                {
                    ...
                    b.OwnsOne("Domain.Entities.Address", "BaseAddress", b1 =>
                        {
                            ...
                            b1.Property<string>("City")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("base_address_city");

                            b1.Property<string>("Country")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("base_address_country");

                            b1.Property<double?>("Latitude")
                                .HasColumnType("double precision")
                                .HasColumnName("base_address_latitude");

                            b1.Property<double?>("Longitude")
                                .HasColumnType("double precision")
                                .HasColumnName("base_address_longitude");

                            b1.Property<string>("PostalCode")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("base_address_postal_code");

                            b1.Property<string>("State")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("base_address_state");

                            b1.Property<string>("Street")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("base_address_street");
