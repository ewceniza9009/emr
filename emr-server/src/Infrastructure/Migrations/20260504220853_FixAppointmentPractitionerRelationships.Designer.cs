...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260504220853_FixAppointmentPractitionerRelationships")]
    partial class FixAppointmentPractitionerRelationships
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.SpiritualAssessment", b =>
                {
                    ...
                    b.Property<Guid>("ClinicalEncounterEncounterId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ClinicalEncounterEncounterId");

                    b.HasIndex("PatientId")
                        .HasDatabaseName("ix_spiritual_assessments_patient_id");

                    b.ToTable("spiritual_assessments");
                });
            ...
            modelBuilder.Entity("Domain.Entities.PatientDocument", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Practitioner", "UploadedBy")
                        ...
                        .HasConstraintName("fk_patient_documents__practitioners_uploaded_by_id");
            ...
            modelBuilder.Entity("Domain.Entities.SpiritualAssessment", b =>
                {
                    b.HasOne("Domain.Entities.ClinicalEncounter", "ClinicalEncounter")
                        .WithMany()
                        .HasForeignKey("ClinicalEncounterEncounterId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_spiritual_assessments_clinical_encounters_clinical_encounte~");
