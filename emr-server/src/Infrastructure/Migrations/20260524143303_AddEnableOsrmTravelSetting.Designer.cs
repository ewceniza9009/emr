...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260524143303_AddEnableOsrmTravelSetting")]
    partial class AddEnableOsrmTravelSetting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CareThread", b =>
                {
                    b.Property<Guid>("CareThreadId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("care_thread_id");
                    ...
                    b.HasKey("CareThreadId")
                        .HasName("pk_care_threads");

                    b.HasIndex("PatientId")
                        .HasDatabaseName("ix_care_threads_patient_id");

                    b.HasIndex("TenantId");

                    b.ToTable("care_threads");
                });

            modelBuilder.Entity("Domain.Entities.CaregiverLink", b =>
                {
                    b.Property<Guid>("CaregiverLinkId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("CaregiverLinkId")
                        .HasName("pk_caregiver_links");

                    b.HasIndex("PatientAccountId")
                        .HasDatabaseName("ix_caregiver_links_patient_account_id");

                    b.HasIndex("TenantId");

                    b.ToTable("caregiver_links", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.ChatMessage", b =>
                {
                    ...
                    b.HasIndex("CareThreadId")
                        .HasDatabaseName("ix_chat_messages_care_thread_id");
            ...
            modelBuilder.Entity("Domain.Entities.Facility", b =>
                {
                    ...
                    b.Property<string>("PlaceOfServiceCode")
                        ...
                        .HasDefaultValue("")
                        .HasColumnName("place_of_service_code");
            ...
            modelBuilder.Entity("Domain.Entities.MagicToken", b =>
                {
                    b.Property<Guid>("MagicTokenId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasColumnName("magic_token_id");
                    ...
                    b.HasKey("MagicTokenId")
                        .HasName("pk_magic_tokens");

                    b.HasIndex("PatientId")
                        .HasDatabaseName("ix_magic_tokens_patient_id");

                    b.HasIndex("TenantId");

                    b.ToTable("magic_tokens");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Patient", b =>
                {
                    ...
                    b.Property<bool>("ConsentHIPAA")
                        .HasColumnType("boolean")
                        .HasColumnName("consent_hipaa");

                    b.Property<bool>("ConsentMarketing")
                        .HasColumnType("boolean")
                        .HasColumnName("consent_marketing");

                    b.Property<bool>("ConsentToTreat")
                        .HasColumnType("boolean")
                        .HasColumnName("consent_to_treat");
                    ...
                    b.Property<string>("DeviceSignature")
                        .HasColumnType("text")
                        .HasColumnName("device_signature");
                    ...
                    b.Property<bool>("HasAdvanceDirective")
                        .HasColumnType("boolean")
                        .HasColumnName("has_advance_directive");

                    b.Property<bool>("HasPoa")
                        .HasColumnType("boolean")
                        .HasColumnName("has_poa");
            ...
            modelBuilder.Entity("Domain.Entities.PatientAccount", b =>
                {
                    b.Property<Guid>("PatientAccountId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PatientId")
                        .IsUnique()
                        .HasDatabaseName("ix_patient_accounts_patient_id");
            ...
            modelBuilder.Entity("Domain.Entities.TenantConfiguration", b =>
                {
                    ...
                    b.Property<int>("AmStartHour")
                        .HasColumnType("integer")
                        .HasColumnName("am_start_hour");
                    ...
                    b.Property<int>("DayEndHour")
                        .HasColumnType("integer")
                        .HasColumnName("day_end_hour");

                    b.Property<bool>("EnableElasticsearch")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_elasticsearch");

                    b.Property<bool>("EnableOsrmTravel")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_osrm_travel");

                    b.Property<bool>("EnableSignalR")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_signal_r");

                    b.Property<bool>("EnableTelemetry")
                        .HasColumnType("boolean")
                        .HasColumnName("enable_telemetry");

                    b.Property<bool>("EnforceMfa")
                        .HasColumnType("boolean")
                        .HasColumnName("enforce_mfa");

                    b.Property<double>("EngineSafetyDistKm")
                        .HasColumnType("double precision")
                        .HasColumnName("engine_safety_dist_km");

                    b.Property<int>("EngineSafetyDriveMins")
                        .HasColumnType("integer")
                        .HasColumnName("engine_safety_drive_mins");

                    b.Property<string>("ExtendedSettingsJson")
                        .HasColumnType("text")
                        .HasColumnName("extended_settings_json");

                    b.Property<int>("IotSyncIntervalMs")
                        .HasColumnType("integer")
                        .HasColumnName("iot_sync_interval_ms");
                    ...
                    b.Property<int>("PmStartHour")
                        .HasColumnType("integer")
                        .HasColumnName("pm_start_hour");

                    b.Property<int>("SessionTimeoutMinutes")
                        .HasColumnType("integer")
                        .HasColumnName("session_timeout_minutes");

                    b.Property<bool>("StrictOnboarding")
                        .HasColumnType("boolean")
                        .HasColumnName("strict_onboarding");

                    b.Property<int>("TelemetryDelaySeconds")
                        .HasColumnType("integer")
                        .HasColumnName("telemetry_delay_seconds");
                    ...
                    b.Property<int>("UrgentPainThreshold")
                        .HasColumnType("integer")
                        .HasColumnName("urgent_pain_threshold");

                    b.Property<int>("UrgentWellbeingThreshold")
                        .HasColumnType("integer")
                        .HasColumnName("urgent_wellbeing_threshold");
                    ...
                    b.ToTable("tenant_configurations");
                });
            ...
            modelBuilder.Entity("Infrastructure.Identity.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("EmergencyAccessExpiry")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Domain.Entities.CareThread", b =>
                {
                    b.HasOne("Domain.Entities.Patient", "Patient")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_care_threads_patients_patient_id");
            ...
            modelBuilder.Entity("Domain.Entities.CaregiverLink", b =>
                {
                    b.HasOne("Domain.Entities.PatientAccount", "PatientAccount")
                        .WithMany("CaregiverLinks")
                        .HasForeignKey("PatientAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_caregiver_links_patient_accounts_patient_account_id");
            ...
            modelBuilder.Entity("Domain.Entities.ChatMessage", b =>
                {
                    b.HasOne("Domain.Entities.CareThread", "CareThread")
                        .WithMany("Messages")
                        .HasForeignKey("CareThreadId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_chat_messages_care_threads_care_thread_id");

                    b.Navigation("CareThread");
                });
                    ...
                    b.OwnsOne("Domain.Entities.Address", "FacilityAddress", b1 =>
                        {
                            ...
                            b1.Property<string>("Region")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("facility_address_region");
            ...
            modelBuilder.Entity("Domain.Entities.MagicToken", b =>
                {
                    b.HasOne("Domain.Entities.Patient", "Patient")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_magic_tokens_patients_patient_id");
            ...
            modelBuilder.Entity("Domain.Entities.PatientAccount", b =>
                {
                    b.HasOne("Domain.Entities.Patient", "Patient")
                        ...
                        .HasForeignKey("Domain.Entities.PatientAccount", "PatientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_patient_accounts_patients_patient_id");
                    ...
                    b.OwnsOne("Domain.Entities.Address", "MailingAddress", b1 =>
                        {
                            ...
                            b1.Property<string>("Region")
                                .IsRequired()
                                .HasColumnType("text")
                                .HasColumnName("mailing_address_region");
            ...
            modelBuilder.Entity("Domain.Entities.Patient", b =>
                {
                    ...
                    b.Navigation("CareNavigationCases");
